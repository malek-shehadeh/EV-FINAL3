        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-2xl font-bold mb-4">{product.price}JD</p>
              ...
              <button
                ...
                className="bg-emerald-600 text-white py-2 px-4 rounded hover:bg-emerald-700 dark:bg-emerald-700 dark:hover:bg-emerald-800 flex items-center gap-2"
              >
                <ShoppingCart />
                Add to Cart
              </button>
